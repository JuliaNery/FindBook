...
<body>
    ...
    <div class="container">
       ...
       <div class="front">
        ...
        <form action="valida-login-biblioteca.php" method="POST">
            <div class="form-content">
                <div class="login-form">
                    <div class="title">Login biblioteca</div>
                    <div class="input-boxes">
                        ...
                        <div class="input-box">
                            ...
                            <input type="password" name="senha" minlength="6" placeholder="Digite a sua senha" required>
                        </div>
                        ...
                        <div class="login-text">Não tem uma conta? <label > <a href="cadastroBiblioteca.php"> Crie uma agora!</label></a></div>
