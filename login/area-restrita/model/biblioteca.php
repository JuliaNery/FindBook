<?php
    ...
    class Biblioteca{
        ...
        public function delete($Biblioteca){
            $conexao = Conexao::conectar();

            $stmt = $conexao->prepare("DELETE FROM tbBiblioteca where idLeitor = ?");
            $stmt ->bindValue(1, $Biblioteca->getIdBiblioteca()); 
        ...
        public function listar(){
            ...
            $querySelect = "SELECT idBiblioteca, fotoBiblioteca, nomeBiblioteca, emailBiblioteca, cepBiblioteca, ruaBiblioteca, numBiblioteca, bairroBiblioteca, telBiblioteca, cidadeBiblioteca
             FROM tbBiblioteca";
        ...
        public function perfil(){
            ...
            $stmt = $conexao->prepare("SELECT idBiblioteca, fotoBiblioteca, nomeBiblioteca, emailBiblioteca, cepBiblioteca, ruaBiblioteca, numBiblioteca, bairroBiblioteca, telBiblioteca, cidadeBiblioteca,  DATE_FORMAT(horarioAbertura,'%H:%i') as horarioAbertura,DATE_FORMAT(horarioFechamento,'%H:%i') as horarioFechamento  
            FROM tbBiblioteca 
            WHERE idBiblioteca = ? ");
