<?php
    ...
    class Livro{
        ...
        public function search($pesquisa){
            ...
            $stmt = $conexao->prepare("SELECT * FROM tbLivro WHERE nomeLivro like '%?%'");
        ...
        public function listar(){
            $conexao = Conexao::conectar();
            $querySelect = "SELECT *, DATE_FORMAT(dtLancamento,'%d/%m/%Y') AS dtLancamento FROM vwLivro order by idLivro asc";
        ...
        public function listarDest(){
            $conexao = Conexao::conectar();
            $querySelect = "SELECT *, DATE_FORMAT(dtLancamento,'%d/%m/%Y') AS dtLancamento from vwLivro
