...
try {
    ...
    $livroFiccao = $Livro->listarFiccao();
    $livroTerror = $Livro->listarTerror();
...
<body>
        ...
        <div class="row">
            <div class="content">
                <div data-anime="left" class="column left">
                    <h3>Bem Vindo, <?php if (!empty($_SESSION['loginLeitor'])) {
                    echo ($_SESSION['loginLeitor']);
                } else {
                    echo $_SESSION['nomeLeitor'];
                } ?></h3>
    ...
    <section class="featured" id="destaques">
        ...
        <h1 class="heading"> <span>Ficção</span> </h1>
        ...
        <div class="container">
            ...
            <!-- CARDS -->
            <div class="products-container">
                <?php foreach ($livroFiccao as $linhas) {  ?>
                    <div class="product" data-name="<?php echo $linhas['idLivro'] ?>">
                        <img src="../../../../<?php echo $linhas['capaLivro'] ?>" alt="">
                        <h3><?php echo $linhas['nomeLivro'] ?></h3>
                    </div>
    ...
    <section class="featured" id="destaques">
        ...
        <div class="container">
            ...
            <!-- CARDS -->
            <div class="products-container">
            <?php foreach ($livroTerror as $linhas) {  ?>
                    <div class="product" data-name="<?php echo $linhas['idLivro'] ?>">
                        <img src="../../../../<?php echo $linhas['capaLivro'] ?>" alt="">
                        <h3><?php echo $linhas['nomeLivro'] ?></h3>
                    </div>
