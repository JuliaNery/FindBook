...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="#" class="active"><i class='bx bx-library icon' ></i> Bibliotecas cadastradas</a></li>
			  ...
			  <div class="container">
                <div class="table-wrapper">
                    <table>
                        ...
                        <tbody>
						<?php foreach ($listaBiblioteca as $linhas) {  ?>
                            <tr>
                                <td>
                                    <div class="user">
                                    <img class="user-image" src="../leitor/img/biblioteca.jpg" alt="">
                                    <div class="user-info">
                                </td>
