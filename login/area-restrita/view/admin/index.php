<?php
	...
	try{
		...
		$qtdDisp = $Exemplar->contadorDispAdmin();
		$qtdInd = $Exemplar->contadorIndAdmin();
...
<body>
	...
	<!-- SIDEBAR -->
	<section id="sidebar">
		<!-- <a href="#" class="brand"><img src="img/logopjt.png" alt="" srcset=""> FindBook</a> -->
	...
	<section id="content">
		...
		<main>
			...
			<a href="./pdf/gerarPDF.php" class="btn-download">
			...
			<div class="table-data">
				...
				<ul class="box-info"> -->
					...
					<i class='bx bxs-book-content'></i>
						<span class="text">
							<h3><?php foreach ($qtdDisp as $disp) {
									echo ($disp['qtd']);
								}?></h3>
