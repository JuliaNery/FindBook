...
<body>
	...
	<main>
		<div class="teste">
			<div class="container">
				<header><a style="color: gray ;" href="exemplares.php">Exemplares</a> / Cadastrar Livros</header>
						...
						<div class="details personal">
							<span class="title">Preencha as informações abaixo:</span>
										...
										<div class="input-field">
											<label> <i class="fas fa-book"></i>Capa do livro:</label>
										</div>
										<div class="image">
							...
							<div class="fields">
								...
								<div class="input-field">
									...
									<input type="number" min="1" max="99" name="txtFaixaEtaria" placeholder="Digite aqui" required>
								</div>
								...
								<div class="input-field">
									<label> Sinopse: </label>
									<textarea name="txtSinopseLivro" type="text" style="border-radius: 5px;" placeholder="Digite aqui..." maxlength="2000" required></textarea>
								</div>
								...
								<div class="buttons">
									...
									<button  type="reset" class="cadastrar">
